---
title: Gitflow工作流[转载]
date: 2018-10-8 18:04:00
updated: 2018-10-8 18:04:00
comments: true
copyright: true
photos: 'https://objects.yongtao.wang/images/20181008/git-workflows-gitflow.png'
---

转载：[Gitflow工作流](https://github.com/oldratlee/translations/blob/master/git-workflows-and-tutorials/workflow-gitflow.md)，李鼎
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-1historical.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-2feature.png)

注意，从各种含义和目的上来看，功能分支加上`develop`分支就是功能分支工作流的用法。但`Gitflow`工作流没有止步于此。

### 发布分支

![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-3release.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-4maintenance.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-5createdev.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-6maryjohnbeginnew.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-7maryfinishes.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-8maryprepsrelease.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-release-cycle-9maryfinishes.png)
...
![](https://objects.yongtao.wang/images/20181008/git-workflow-gitflow-enduserbug.png)
...
到了这里，但愿你对集中式工作流、功能分支工作流和`Gitflow`工作流已经感觉很舒适了。
